<?php require_once 'components/header.php' ?>
    ...
    <div class="d-flex flex-column mt-5 ms-2 me-2">
                ...
                <tbody>
                    <?php foreach($result as $key=>$value): ?>
                        <tr>
                            ...
                            <td><a href="<?php echo "http://localhost/booking_train/managment/cancelTrip/" . $value['id']; ?>" class="text-danger">Delete</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <table class ="table mt-4 fw-bold mb-4">
                <thead class="table-dark">
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?=$value['date']?></td>
                        <td><a href ="<?php echo "http://localhost/booking_train/managment/deletebooking/" . $value['id']; ?>" class ="btn text-danger fw-bold" style="margin:0px; padding:0px">Delete Booking</a></td>
                    </tr>
                </tbody>
                <?php endforeach; ?>
            </table>
