            ...
            <div class="mt-5 position-absolute popup-container" id="popup-wrapper" style="background-color: #ff5f00;">
                <Form action = "http://localhost/booking_train/booking/booknow" method = "POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" class="form-control" id="full_name" name="full_name" value="<?php if(isset($_SESSION["id"])) {echo $_SESSION['full_name'];}else {echo 'khfsd';} ?>" required>
                          </div>
                        <div class="mt-4">
                            <label for="email" class="form-label">Your Email</label>
                            <input value="<?php if(isset($_SESSION["id"])) {echo $_SESSION['email'];}else {echo 'jbshdf';} ?>" type="text" class="form-control" id="email" name="email" required>
                        </div>
                        <div class="mt-4">
