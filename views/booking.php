        ...
        <table class ="table mt-4 fw-bold">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="<?php if ($cancel_available == true){ echo 'http://localhost/booking_train/booking/deleteBooking/' . $value['id'];} {echo "";}?>" class ="btn text-danger fw-bold" style="margin:0px; padding:0px">Cancel Trip</a></td>
                    </tr>
                </tbody>
                <?php endforeach; ?>
            </table>
