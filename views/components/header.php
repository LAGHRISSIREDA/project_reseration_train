...
<body style="background-color: #f5f6fa">
    <div class="main-section">
            <!-- Navbar -->
            <nav class="navbar navbar-expand-lg bg-primary shadow navbar-dark py-3" >
          <div class="container">
            <a href="#" class="navbar-brand fw-bold">Travel<span class="text-warning fw-bold">.</span>ma</a>
            <button
