    ...
    <div class="container d-flex flex-column align-items-center">
        ...
        <div class="auth-section">
                ...
                <div class="right-auth-container">
                    <Form class ="auth-form" action="http://localhost/booking_train/signup/signup_function" method = "POST">
                        ...
                        <button type="submit" class="btn text-white fw-bold pt-2 pb-2 ps-4 pe-4 mt-3" style="background-color:#ff5f00">Sign up</button>
                    </Form>                    
                </div>
        </div>
    </div>
